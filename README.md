...
800명 정원의 학교 설명회를 위한 선착순 신청 시스템입니다. 오픈 32초 만에 마감되는 환경에서 정원을 초과하지 않고 신청 번호를 정확히 발급하는 것을 목표로 설계했습니다.
...
- 정원 정확 마감 (800/800) — 오픈 정각부터 32.3초
- 신청 번호 1번부터 800번까지 중복과 누락 없이 연속 배정 (서버 기록 대조)
